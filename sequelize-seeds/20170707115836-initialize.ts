...
const sampleBrainProject = process.env.PIPELINE_SAMPLE_PROJECT ||  "2019-05-27";
const stageOutputBasePath = path.join(process.env.PIPELINE_SAMPLE_OUTPUT ||  "/nrs/mouselight/pipeline-testing}", sampleBrainProject);
...
function createProjects(when: Date) {
    if (isProduction) {
        ...
        return [{
            ...
            root_path: path.join(devProjectLocationPrefix, "Dashboard Output/small"),
            log_root_path: "",
            sample_number: 99998,
            region_x_min: null,
            region_x_max: null,
            ...
            root_path: path.join(devProjectLocationPrefix, "Dashboard Output/large"),
            log_root_path: "",
            sample_number: 99999,
            region_x_min: null,
            region_x_max: null,
...
function createPipelineStages(when: Date) {
    if (isProduction) {
        return [{
            ...
            dst_path: path.join(stageOutputBasePath, "stage_1_line_fix_output"),
            function_type: 2,
            is_processing: false,
            depth: 1,
            ...
            dst_path: path.join(stageOutputBasePath, "stage_2_classifier_output"),
            function_type: 2,
            is_processing: false,
            depth: 2,
            project_id: "44e49773-1c19-494b-b283-54466b94b70f",
            ...
            dst_path: path.join(stageOutputBasePath, "stage_3_descriptor_output"),
            function_type: 2,
            is_processing: false,
            depth: 3,
            project_id: "44e49773-1c19-494b-b283-54466b94b70f",
            ...
            dst_path: path.join(stageOutputBasePath, "stage_4_point_match_output"),
            function_type: 5,
            is_processing: false,
            depth: 4,
            project_id: "44e49773-1c19-494b-b283-54466b94b70f",
        ...
        return [{
            ...
            name: "Classifier",
            description: "Classifier",
            dst_path: path.join(devProjectLocationPrefix, "PipelineOutput1"),
            function_type: 2,
            is_processing: false,
            depth: 1,
            ...
            name: "Descriptors",
            description: "Descriptors",
            dst_path: path.join(devProjectLocationPrefix, "PipelineOutput2"),
            function_type: 2,
            is_processing: false,
            depth: 2,
            project_id: "af8cb0d4-56c0-4db8-8a1b-7b39540b2d04",
            ...
            dst_path: path.join(devProjectLocationPrefix, "PipelineOutput3"),
            function_type: 5,
            is_processing: false,
            depth: 3,
            project_id: "af8cb0d4-56c0-4db8-8a1b-7b39540b2d04",
