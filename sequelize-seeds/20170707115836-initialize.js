...
module.exports = {
    up: (queryInterface, Sequelize) => __awaiter(this, void 0, void 0, function* () {
        const when = new Date();
        yield queryInterface.bulkInsert("TaskDefinitions", createTaskDefinitions(when), {});
        yield queryInterface.bulkInsert("Projects", createProjects(when), {});
        yield queryInterface.bulkInsert("PipelineStages", createPipelineStages(when), {});
        yield queryInterface.bulkInsert("PipelineStageFunctions", createPipelineStageFunction(when), {});
    }),
    down: (queryInterface, Sequelize) => __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.bulkDelete("PipelineStageFunctions", null, {});
        yield queryInterface.bulkDelete("PipelineStages", null, {});
        yield queryInterface.bulkDelete("Projects", null, {});
        yield queryInterface.bulkDelete("TaskDefinitions", null, {});
    })
};
//# sourceMappingURL=20170707115836-initialize.js.map